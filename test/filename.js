...
describe("Filename function", function () {
  ...
  it("should split long file names according to line length", function () {
    assert.equal(
        filename("123_123456789_123_1233445678_0123456789_123", 10, "|"),
        "123_123456|789_123_12|33445678_0|123456789_|123"
    );
    assert.equal(
  ...
  it("should split long word with extensions according to line length", function () {
    assert.equal(
        filename("123_123456789_123_123445678_0123456789.txt", 10, "|"),
        "123_123456|789_123_1|23445678_|0123456789|.txt"
    );
    assert.equal(
        filename("123_123456789_123_123445678_0123456789_1.txt", 5, "|"),
        "123_1|23456|789_1|23_12|34456|78_01|23456|789_1|.txt"
    );
    assert.equal(
    ...
    assert.equal(
        ...
        "123_123456|789_123_12|3445678_01|23456789_1|234|.jpg"
    );
    assert.equal(
        filename("123_123456789_123_123445678_0123456789_123456.json", 10, "|"),
        "123_123456|789_123_12|3445678_01|23456789_1|23456|.json"
    );
    assert.equal(
        filename("123_123456789_123_123_123445678_0123456789_1234.json", 10, "|"),
  ...
  it("should not split words if they don\"t fit into line", function () {
    ...
    assert.equal(
        filename("1234567 1234", 10, "|"),
        "1234567 |1234" // "12345 |1234" will be ok too
    );
    ...
    assert.equal(
        filename("12345 1234 1234567.mp4", 10, "|"),
        "12345 1234 |1234567|.mp4"
    );
  });
